...
public class WordListAdapter extends ListAdapter<WordEntity, WordViewHolder> {
    public WordListAdapter(@NonNull DiffUtil.ItemCallback<WordEntity> diffCallback) {
        super(diffCallback);
    }
